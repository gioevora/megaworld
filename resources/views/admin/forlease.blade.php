                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 ">
                            <div class="border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center" style="background-color: #202A54;">
                                ...
                                <a href="/Admin/Add/Lease" type="button" class="btn" style="margin-right: 10px; background-color: #f6d200">
                                    Add Properties
                                </a>
                                        ...
                                        <tr data-residence-id="{{ $town->id }}" data-residence-name="{{ $town->name }}" data-residence-location="{{ $town->location }}" data-residence-status="{{ $town->status }}" data-residence-description="{{ $town->description }}">
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{asset('/storage/properties_img/' . $town->image) }}" alt="Township Image" style="max-width: 60px; max-height: 60px;">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm mx-4">{{$town->lease_name}}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>

                                                <span class="badge <?php echo $town->status === 'Pending' ? 'bg-danger' : 'bg-success'; ?> text-white">
                                                    {{ $town->status }}
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge <?php echo $town->type === 'Residentials' ? 'bg-primary' : 'bg-secondary'; ?> text-white">
                                                    {{ $town->type }}
                                                </span>
                                            </td>
                                            <td class="d-flex flex-row justify-content-center">
                                                ...
                                                <button type="submit" class="btn btn-success text-white disabled " style="margin-right: 10px;">
                                                    Publish
                                                </button>
                                                @else
                                                <form action="{{ route('publish',  ['id' => $town->id]) }}" method="post">
                                                    @csrf

                                                    <button type="submit" class="btn btn-success text-white" style="margin-right: 10px;">
                                                        Publish
                                                    </button>
                                                </form>
