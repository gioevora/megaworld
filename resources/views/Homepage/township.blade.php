...
<body style="background-image: url('img/home-bg-pattern.png'); background-repeat:repeat; z-index: -2;">
    ...
    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel" data-interval="5000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('img/tuscany_0.jpg')}}" class="d-block w-100" alt="...">
                <div class="township">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="banner-header">Township</p>
                            <p class="banner-text">The Mactan Newtown is the first Megaworld township development outside of Metro Manila with its own beachfront. This 28.8-hectare mega-community combines high-end office towers, luxury condominiums, leisure amenities, retail shops, upscale hotels, and school.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="main-content">
        <div class="container">
            <div class="block-heading" style="text-align: center; margin-top:5%;">
                <h2 class="heading">We Don't Just Build, We Synergize</h2>
                <div class="desc-medium">
                    <p>Our hope is to surround you with everything you may possibly need to go about your daily routine, making it easier for you to live, work, play and learn. </p>
                </div>
            </div>

            <div class="block-body mb-2">
                <div class="row">
                    <div class="col-md-7 position-relative mb-2">
                        <div class="img-zoom">
                            <img src="{{asset('img/live2_0.jpg')}}" alt="">
                        </div>
                        <div class="box-overlay position-absolute top-0 start-0">
                            <div class="title px-4 py-4" style="color: #fff;">Live</div>
                        </div>
                    </div>

                    <div class="col-md-5 position-relative">
                        <div class="img-zoom">
                            <img src="{{asset('img/work2_0.jpg')}}" alt="">
                        </div>

                        <div class="box-overlay position-absolute top-0 start-0">
                            <div class="title px-4 py-4" style="color: #fff;">Work</div>
                        </div>
                    ...
                    <div class="col-md-5 position-relative">
                        <div class="img-zoom">
                            <img src="{{asset('img/play2_0.jpg')}}" alt="">
                        </div>

                        <div class="box-overlay position-absolute top-0 start-0">
                            <div class="title px-4 py-4" style="color: #fff;">Play</div>
                        </div>
                    ...
                    <div class="col-md-7 position-relative">
                        <div class="img-zoom">
                            <img src="{{asset('img/learn2.jpg')}}" alt="">
                        </div>
                        <div class="box-overlay position-absolute top-0 start-0">
                            <div class="title px-4 py-4" style="color: #fff;">Learn</div>
                        </div>
                    </div>
            ...
            <div class="section" id="grid-region">
                <div class="block-heading" style="text-align: center;">
                    ...
                    <h2 class="heading">All that Matters, Within Your Reach</h2>
                    <div class="desc-medium">
                        <p>We are all about creating advantages to suit your needs. Walk around our townships and you will find that whatever you're looking for, is just a few steps away.</p>
                    </div>
                    <div class="row">

                        <div class="col-md-7 position-relative mb-2">
                            <div class="img-zoom">
                                <img src="{{asset('img/capital-town.jpg')}}" alt="" style="height: 300px; width:100%">
                            </div>
                            <div class="box-overlay position-absolute top-0 start-0" style="margin-top: 2%; margin-left:5%; padding: 10px 10px">
                                <div class="title" style="color: #fff;">Arden Botanical Estate</div>
                                <p style="text-align: start; color:#fff">Cavite</p>
                            </div>
                        </div>

                        <div class="col-md-5 position-relative mb-2">
                            <div class="img-zoom">
                                <img src="{{asset('img/arden-botanical-estate-township-cavite-thumbnail-grid.jpg')}}" alt="" style="height: 300px; width:100%">
                            </div>

                            <div class="box-overlay position-absolute top-0 start-0" style="margin-top: 2%; margin-left:3%;  padding: 10px 10px">
                                <div class="title" style="color: #fff;">Capital Town</div>
                                <p style="text-align: start; color:#fff">Pampanga</p>
                            </div>
                        </div>

                        <div class="col-md-7 position-relative mb-2">
                            <div class="img-zoom">
                                <img src="{{asset('img/westside.jpg')}}" alt="" style="height: 300px; width:100%">
                            </div>
                            <div class="box-overlay position-absolute top-0 start-0" style="margin-top: 2%; margin-left:5%; padding: 10px 10px">
                                <div class="title" style="color: #fff;">Westsie City</div>
                                <p style="text-align: start; color:#fff">Paranaque</p>
                            </div>
                        </div>

                        <div class="col-md-5 position-relative mb-2">
                            <div class="img-zoom">
                                <img src="{{asset('img/megaworld-the-upper-east-township-negros-occidental-grid.jpg')}}" alt="" style="height: 300px; width:100%;">
                            </div>

                            <div class="box-overlay position-absolute top-0 start-0" style="margin-top: 2%; margin-left:3%;  padding: 10px 10px">
                                <div class="title" style="color: #fff;">The Upper East</div>
                                <p style="text-align: start; color:#fff">Bacolod</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 position-relative mb-2">
                            <div class="img-zoom">
                                <img src="{{asset('img/maple-grove.jpg')}}" alt="" style="height: 300px; width:100%;">
                            </div>

                            <div class="box-overlay position-absolute top-0 start-0" style="margin-top: 2%; margin-left:3%;  padding: 10px 10px">
                                <div class="title" style="color: #fff;">Maple Grove</div>
                                <p style="text-align: start; color:#fff">Cavite</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 position-relative mb-2">
                            <div class="img-zoom">
                                <img src="{{asset('img/southwoods.jpg')}}" alt="" style="height: 300px; width:100%">
                            </div>
                            <div class="box-overlay position-absolute top-0 start-0" style="margin-top: 2%; margin-left:5%; padding: 10px 10px">
                                <div class="title" style="color: #fff;">Southwoods City</div>
                                <p style="text-align: start; color:#fff">Laguna</p>
                            </div>
                        </div>
                ...
                <div class="btn-wrapper">
                    <a href="/townships-filter" class="button secondary-button icon-arrow-right">
                        <span class="button-text">View more</span>
                        <span class="icon-wrapper"><img src="/sites/default/files/icons/right-arrow2.png" class="loaded"></span>
                    </a>
                </div>
            </div>
