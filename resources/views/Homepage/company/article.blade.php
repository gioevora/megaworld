            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="578" role="article" about="ompanys-article-incorporation-and-laws" class="node townships node--type-page-with-list node--promoted node--view-mode-full">

                            <div class="company-page">
                                <h2 class="corporate-heading"><span class="field field--name-title field--type-string field--label-hidden">Company's Article of Incorporation and By-Laws</span>
                                </h2>
                                ...
                                <div class="field field--name-field-page-link field--type-entity-reference field--label-hidden field__items">
                                    <div class="field__item">
                                        <div class="pdf-item">
                                            <div class="link-title-wrapper">
                                                <div class="title text-med-blue"><span class="field field--name-title field--type-string field--label-hidden">Articles of Incorporation</span>
                                                </div>
                                                <div class="btn-wrapper btn-regular fright"><a href="/company/articles-incorporation">View</a></div>
                                                <div class="clear">&nbsp;</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="field__item">
                                        <div class="pdf-item">
                                            <div class="link-title-wrapper">
                                                <div class="title text-med-blue"><span class="field field--name-title field--type-string field--label-hidden">By Laws</span>
                                                </div>
                                                <div class="btn-wrapper btn-regular fright"><a href="/company/by-laws">View</a></div>
                                                <div class="clear">&nbsp;</div>
                                            </div>
                                        </div>
                                    </div>
