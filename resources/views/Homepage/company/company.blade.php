                ...
                <div class="col-12">
                    <nav>
                         <ul class="primary justify-content-center ">
                            <li> <a href="/company/corporate-profile" class="active">Company</a></li>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="122" role="article" about="/investors/company/corporate-profile" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="Corporate Profile" class="rdf-meta hidden"></span>

                            <div class="node__content">

                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="company-page corporate-profile">
                                        <h2 class="corporate-heading">Corporate Profile</h2>

                                        <div style="text-align:justify;">
                                            <div class="short-desc">
                                                <p>Megaworld Corporation (“Megaworld,” “the Company,” “MEG”) was founded by Dr. Andrew Tan and incorporated under Philippine law on August 24, 1989, to engage in the development, leasing, and marketing of real estate. The Company initially established a reputation for building high-end residential condominiums and commercial properties in convenient urban locations with easy access to offices, leisure, and entertainment amenities in Metro Manila. Beginning in 1996, in response to the demand for lifestyle convenience of having quality residences close to office and leisure facilities, the Company started to focus on developing mixed-use communities, primarily for the middle-income market, by commencing its Eastwood City community township development. In addition, the Company engages in other propertyrelated activities such as project design, construction oversight, and property management. On August 19, 1999, Megaworld changed its corporate name to the present one to coincide with its conversion from a purely real estate company into a holding company. However, the Company continues to focus its core competence on real estate development.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
