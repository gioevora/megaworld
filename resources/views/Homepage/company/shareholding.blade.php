...
<article data-history-node-id="624" role="article" about="/investors/company/companys-shareholding-structure" class="node townships node--type-reports node--promoted node--view-mode-full">
  ...
  <div class="company-page">
        <h2 class="heading">Company's Shareholding Structure  </h2>
        
    <div class="link-title-wrapper">
        <div class="title"><span class="fa fa-file-pdf">&nbsp;</span> <span class="field field--name-title field--type-string field--label-hidden">Company's Shareholding Structure</span>
</div>
        <div class="btn-wrapper"><a class="button secondary-button icon-arrow-right" href="/investors/sites/investors/files/2018-05/Conglomerate-Map-of-Related-Parties-2013_0.pdf"><span class="button-text">Download PDF</span> <span class="icon-wrapper"><img class="loaded" src="/investors/sites/default/files/icons/right-arrow2.png"></span> </a></div>
        <div class="clear">&nbsp;</div>
    </div>
    <div class="pdf-wrapper">
      <iframe src="https://docs.google.com/gview?url=https://www.megaworldcorp.com/investors/sites/investors/files/2018-05/Conglomerate-Map-of-Related-Parties-2013_0.pdf&amp;embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>
    </div>
</div>
