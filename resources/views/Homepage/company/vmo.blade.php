            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="126" role="article" about="/investors/investors/company/mission-vision-and-values" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="Vision, Mission and Values" class="rdf-meta hidden"></span>

                            <div class="node__content">

                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="company-page page-mision-vision">
                                        <h2 class="corporate-heading">Vision, Mission and Values</h2>
                                        <p><u><strong>Vision Statement</strong></u></p>

                                        <p>We uplift lives, impact society and help shape the nation.</p>

                                        <p>&nbsp;</p>

                                        <p><u><strong>Mission Statement</strong></u></p>

                                        <ul>
                                            <li>We&nbsp;pioneer concepts that promote integrated lifestyles in the townships we build.</li>
                                            <li>We advocate responsible stewardship of the environment.</li>
                                            <li>We deliver long-term value for our employees and shareholders.</li>
                                            <li>We spur economic growth all over the country.</li>
                                        </ul>
                                        <p>&nbsp;</p>

                                        <p><u><strong>Values</strong></u></p>
