            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="546" role="article" about="/investors/company/conglomerate-map" class="node townships node--type-reports node--promoted node--view-mode-full">
                            ...
                            <div class="company-page">
                                <h2 class="heading">Conglomerate Map </h2>

                                <div class="link-title-wrapper">
                                    <div class="title"><span class="fa fa-file-pdf">&nbsp;</span> <span class="field field--name-title field--type-string field--label-hidden">Conglomerate Map</span>
                                    </div>
                                    <div class="btn-wrapper"><a class="button secondary-button icon-arrow-right" href="/investors/sites/investors/files/2023-02/Conglomerate%20map%20as%20of%2031%20December%202022.pdf"><span class="button-text">Download PDF</span> <span class="icon-wrapper"><img class="loaded" src="/investors/sites/default/files/icons/right-arrow2.png"></span> </a></div>
                                    <div class="clear">&nbsp;</div>
                                </div>
                                <div class="pdf-wrapper">
                                    <iframe src="https://docs.google.com/gview?url=https://www.megaworldcorp.com/investors/sites/investors/files/2023-02/Conglomerate%20map%20as%20of%2031%20December%202022.pdf&amp;embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>
                                </div>
                            </div>
