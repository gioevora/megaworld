            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="570" role="article" about="/company/articles-incorporation" class="node page-with-attachment node--type-page-with-attachment node--promoted node--view-mode-full">

                            <div class="company-page">
                                <h2 class="corporate-heading"><span class="field field--name-title field--type-string field--label-hidden">By Laws</span>
                                </h2>
