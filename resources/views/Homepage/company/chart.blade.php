            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="123" role="article" about="/investors/investors/company/organizational-chart" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="Organizational Chart" class="rdf-meta hidden"></span>
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="company-page organizational-chart">
                                        <h2 class="corporate-heading">Organizational Chart</h2>

                                        <div class="wrap-image"><img alt="Organizational Chart" data-entity-type="file" data-entity-uuid="ff3e3189-bd03-44e5-bb75-9c3265ffa7cd" src="{{asset('img/Org%20Map.png')}}" style="width:100%; height:auto;" class="align-center">
                                            <p>&nbsp;</p>
                                        </div>
                                    </div>
                                </div>
