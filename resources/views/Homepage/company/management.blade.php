            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="125" role="article" about="/investors/investors/company/management-team-and-executive-officers" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="Management Team and Executive Officers" class="rdf-meta hidden"></span>
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="company-page management">
                                        <h2 class="corporate-heading">Management Team and Executive Officers</h2>

                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Andrew L. Tan</div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Lourdes T. Gutierrez-Alfonso</div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Kevin Andrew L. Tan</div>

                                                    <div class="position">Executive Vice President</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Kingson U. Sian</div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Francisco C. Canuto</div>

                                                    <div class="position">Senior Vice President</div>

                                                    <div class="position">Chief Finance Officer</div>

                                                    <div class="position">Treasurer</div>

                                                    <div class="position">Chief Audit Executive</div>

                                                    <div class="position">Compliance Officer and Corporate Information Officer</div>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Giovanni C. Ng</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Noli D. Hernandez</div>

                                                    <div class="position">Executive Vice President for Sales and Marketing</div>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Maria Victoria M. Acosta</div>

                                                    <div class="position">Senior Vice President for International Marketing and Leasing</div>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Jennifer L. Romualdez</div>

                                                    <div class="position">Head for Operations Management</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Maria Carla T. Uykim</div>

                                                    <div class="position">Head of Corporate Advisory and Compliance Division</div>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Rafael Antonio S. Perez</div>

                                                    <div class="position">Head of Human Resources and Corporate Administration Division</div>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Graham M. Coates</div>

                                                    <div class="position">Head of Megaworld Lifestyle Malls</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Kimberly Hazel A. Sta. Maria</div>

                                                    <div class="position">Assistant Vice President for Corporate Communications and Advertising</div>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Anna Michelle T. Llovido</div>

                                                    <div class="position">Corporate Secretary</div>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="grid-item"><!-- <div class="wrap-image"><img src="/megaworld-drupal/investors/sites/investors/files/inline-images/Rectangle-3.jpg" /></div> -->
                                                    <div class="text-med">Nelileen S. Baxa</div>

                                                    <div class="position">Assistant Corporate Secretary</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
