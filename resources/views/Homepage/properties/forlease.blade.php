    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-10 col-12">
                <form action="{{ route('properties.searchlease') }}" method="GET" class="search">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 px-0">
                <div class="room-item">
                      <a href="{{route('view-lease', ['id'=>$proper->id])}}">
                    <div class="properties">
                       @if($proper->first_image)
                            <img src="{{ asset('/storage/properties_img/' . $proper->first_image) }}" >
                        @else
                            <img src="{{ asset('path/to/default-image.jpg') }}">
                        @endif
                        <div class="properties-label">
                            <h6>
                                <span class="badge <?php echo $proper->type === 'Commercials' ? 'bg-primary' : 'bg-info'; ?> text-white">
                                    {{ $proper->type }}
                                </span>
                            </h6>
                        </div>
                    ...
                    <div class="ri-text">
                        <div class="item-details pt-1 d-block ">
                                ...
                                <h5 class="text-truncate">{{$proper->lease_name }}</h5>
