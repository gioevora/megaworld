...
<body style="background-image: url('img/home-bg-pattern.png'); background-repeat:repeat; z-index: -2;">
    ...
    <div class="site-navbar-wrap js-sticky-header" style="background-color:rgba(22, 116, 193, 0.7);  ">
                    ...
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="225" role="article" about="/investors/company-disclosures/statement-changes" class="node townships node--type-page-with-list node--promoted node--view-mode-full">
                            ...
                            <div class="company-page">
                                <h2 class="corporate-heading"><span class="field field--name-title field--type-string field--label-hidden">Quarterly Report</span>
                                </h2>
