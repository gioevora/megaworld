    ...
    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel" data-interval="5000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('img/hotel-landing-page-revised.jpg')}}" class="d-block w-100" alt="...">
                <div class="offices">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{asset('img/meg-hotels-and--resorts.png')}}" alt="" width="80%" style="margin-top:10px; margin-bottom:10px;">

                            <p class="banner-text">As the country’s biggest owner and operator of 100% Filipino homegrown hotel brands, Megaworld supports the Philippine tourism sector by showcasing the best experiences from some of the country’s top destinations that travelers can look forward to and enjoy.</p>

                            <div class="hotel-button pt-4" style="color:#fff">
                                <a style="color: #fff; font-size:.8rem; text-decoration:none;   text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);" href="https://www.megaworldhotels.com/">
                                    VIEW MEGAWORLD HOTELS &amp; RESORTS WEBSITE
                                </a>
                            </div>
    ...
    <div class="main-content">
        <div class="brand-carousel section-padding owl-carousel">
            <div class="single-logo">
                <img src="{{asset('img/savoy hotels_0.png')}}" alt="">
            </div>
            <div class="single-logo">
                <img src="{{asset('img/hotel lucky chinatown_0.png')}}" alt="">
            </div>
            <div class="single-logo">
                <img src="{{asset('img/richmonde hotels_0.png')}}" alt="">
            </div>
            <div class="single-logo">
                <img src="{{asset('img/belmont hotels and resorts.png')}}" alt="">
            </div>
            <div class="single-logo">
                <img src="{{asset('img/KingsfordLogoWhiteBG_page-0001_0.png')}}" alt="">
            </div>
            <div class="single-logo">
                <img src="{{asset('img/twin lakes hotel_0.png')}}" alt="">
            </div>
        </div>


        <div class="content-with-background" style="background: url('img/hotel-bg.jpg') no-repeat;">
            <div class="container">
                <div class="block-heading">
                    <h2 class="heading" style="padding-top:5%;">Our heart, your home</h2>
                    <div class="desc-medium">
                        <p style="padding-bottom:5%;">Megaworld Hotels &amp; Resorts is the largest hospitality chain in the Philippines, boasting around 7,700 room keys in Metro Manila and major tourist destinations in the provinces, such as Mactan in Cebu, Iloilo, Boracay, and soon Bacolod. We are building a strong hotel portfolio that even on short-term stays, families will make their time in our townships truly memorable.<br>
                            <br>
                ...
                <div class="row">
                    <div class="col-md-5"> <!-- Added p-3 for padding -->
                        <div class=" mb-3 position-relative">
                            <div class="img-zoom">
                                <img src="{{asset('img/belmonthotelmanila_grid_0.jpg')}}" alt="" width="100%">
                            </div>
                            <div class="box-overlay position-absolute top-0 start-0 p-3" style="transform: translate(10px, 0px);">
                                <div class="title" style="color: #fff;">Belmont Hotel Manila</div>
                                <p class="text-white">Pasay City</p>
                            </div>
                    ...
                    <div class="col-md-7">
                        <div class="mb-3 position-relative">
                            <div class="img-zoom">
                                <img src="{{asset('img/110246019_284035502666997_358099050051077148_n_0.jpg')}}" alt="" width="100%">
                            </div>
                            <div class="box-overlay position-absolute top-0 start-0 p-3" style="transform: translate(10px, 0px);">
                                <div class="title" style="color: #fff;">Twin Lakes Hotel</div>
                                <p class="text-white">Tagaytay</p>
                            </div>
                        </div>
                        <div class="mb-3 position-relative">
                            <div class="img-zoom">
                                <img src="{{asset('img/savoy-boracay-thumbnail.jpg')}}" alt="" width="100%">
                            </div>
                            <div class="box-overlay position-absolute top-0 start-0 p-3" style="transform: translate(10px, 0px);">
                                <div class="title" style="color: #fff;">Savoy Hotel Boracay</div>
                                <p class="text-white">Boracay</p>
                            </div>
                        </div>
                    </div>
