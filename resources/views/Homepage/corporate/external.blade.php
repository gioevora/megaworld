            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="1523" role="article" about="/investors/corporate-governance/external-audit-meetings-internal-audit" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="External Auditor Meetings with Internal Audit" class="rdf-meta hidden"></span>
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    ...
                                    <h2 class="corporate-heading">External Auditor Meetings with Internal Audit</h2>

                                    <p><br>
                                        Megaworld Corporation’s Audit Committee shall conduct a separate meeting in executive session with the Independent Auditors to discuss any matter that the Committee or Independent Auditors believe should be discussed privately without the presence of management, including the results of the audit, year-end financial statements, the quality of management, financial, and accounting controls.</p>
                                </div>
