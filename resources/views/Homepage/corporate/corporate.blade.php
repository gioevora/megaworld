            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="primary justify-content-center ">
                            ...
                            <li > <a href="/corporate-governance" class="active">Corporate Governance</a></li>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="1515" role="article" about="/corporate-governance/about" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    ...
                                    <h2 class="corporate-heading">A CULTURE OF INTEGRITY, ACCOUNTABILITY AND TRANSPARENCY</h2>

                                    <div class="company-page page-risk-management" style="text-align:justify;">
                                        <p>Megaworld Corporation pursues the sustainability of its business as well as shared value for its stakeholders by anchoring its corporate activities on the highest standards of corporate governance. A culture of integrity, transparency and accountability governs the company’s operations, driving its move to continuously build on the value it has created for its shareholders, investors, employees and the community.</p>

                                        <p>Consistently strengthening its corporate governance system and practices is a commitment of Megaworld, as it is aligned with its vision to uplift lives, impact society and help shape the nation. The company fully adheres to the rules and regulations of the Philippine Stock Exchange, the Securities and Exchange Commission, and the Philippine Dealing &amp; Exchange Corporation.</p>
                                    </div>
                                </div>
