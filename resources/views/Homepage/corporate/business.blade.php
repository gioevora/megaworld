...
<body style="background-image: url('img/home-bg-pattern.png'); background-repeat:repeat; z-index: -2;">
    ...
    <div class="video-container">
        <img src="{{asset('img/our business.jpg')}}" alt="Background Image" style="background-size: cover; width: 100%;">
        <div class="title-header">
            <p class="banner-header" style="margin-top:5%;">Our Business</p>
        </div>
    </div>
    ...
    <main role="main" style="min-height: 400px;">
        ...
        <div class="container">
            ...
            <div class="region region-two-col-main">
                ...
                <article data-history-node-id="157" role="article" about="/investors/investors/our-business" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                    <span property="schema:name" content="Our Business" class="rdf-meta hidden"></span>

                    <div class="node__content">

                        <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                            <div class="company-page page-our-business">
                                <h2 class="corporate-heading">Our Business</h2>

                                <div class="text-gray paragraph">Megaworld Corporation is transforming the Metro Manila landscape through a series of large-scale residential and office developments including urban centers integrating office, residential and commercial components. Apart from its core business of property development, Megaworld as a holding company is into merchandise trading as well as hotel and leisure.</div>

                                <div class="text-gray paragraph">Megaworld continues to build upon a track record for quality and innovation centered on customer satisfaction through high-caliber projects delivered on time and backed by professional property management and after-sales services.</div>

                                <div class="text-gray paragraph">Testament to Megaworld's industry leadership are the numerous awards received through the years. In 2007 alone, Megaworld was awarded the following:</div>

                                <div class="text-gray ">- Overall Best Managed Company and Best in Investor Relations in the Philippines in the Asia Money Polls</div>

                                <div class="text-gray ">- Best Investor Relations in the Singapore Market by a Philippine Company by IR Magazine (Singapore)</div>

                                <div class="text-gray">- Philippines Best Managed Company, Most Committed to Corporate Governance, and Best in Investor Relations by Finance Asia</div>
                            </div>
                        </div>
