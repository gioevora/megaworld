            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="1514" role="article" about="/investors/corporate-governance/board-directors" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="company-page page-board">
                                        <h2 class="corporate-heading">Board of Directors</h2>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="wrap-image"><img src="{{asset('/storage/township_images/' . $dir    ->image) }}"></div>
                                                </div>

                                                <div class="col-md-8">
                                                    <div>
                                                        <div class="text-med">{{$dir->name}}</div>

                                                        <div class="position">{{$dir->position}}</div>

                                                        <div class="expand-container">
                                                            <div class="slide-body">
                                                                <div style="text-align:justify">{{$dir->description}}</div>
                                                            </div>

                                                            <div class="expander">See More <span class="fa fa-angle-down">&nbsp;</span></div>
                                                        </div>
                                                    </div>
                                                </div>
