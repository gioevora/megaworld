            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        <article data-history-node-id="585" role="article" about="/investors/corporate-governance/manual-corporate-governance" class="node page-with-attachment node--type-page-with-attachment node--promoted node--view-mode-full">
                            <div class="company-page">
                                <h2 class="manual-heading"><span class="field field--name-title field--type-string field--label-hidden">Manual on Corporate Governance</span>
                                </h2>
                                <div class="field field--name-field-reports field--type-entity-reference field--label-hidden field__items">
                                    <div class="field__item">
                                        @foreach($corpo as $docs)
                                        <div class="pdf-item">
