            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="585" role="article" about="/corporate-governance/manual-corporate-governance" class="node page-with-attachment node--type-page-with-attachment node--promoted node--view-mode-full">

                            <div class="company-page">
                                <h2 class="manual-heading"><span class="field field--name-title field--type-string field--label-hidden">Board Committe Charter</span>
                                </h2>
                                        ...
                                        <div class="pdf-item">
                                            <div class="link-title-wrapper">
                                                <div class="title"><span class="fa fa-file-pdf">&nbsp;</span>
                                                    <a href="/corporate-governance/meg-revised-manual-corporate-governance-2014">
