            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="1599" role="article" about="/investors/investors/corporate-governance/cg-training-and-seminars" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="CG Training and Seminars" class="rdf-meta hidden"></span>
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    ...
                                    <h2 style="color:#003366;">CG Training and Seminars</h2>

                                    <p>&nbsp;</p>

                                    <div class="short-desc paragraph">In compliance with the Securities and Exchange Commission’s (SEC) Revised Code on Corporate Governance, the members of the Board of Directors and key officers of Megaworld Corporation attend a program on corporate governance.</div>

                                    <div class="short-desc paragraph">&nbsp;</div>

                                    <div class="short-desc paragraph"><strong>2022 Annual Corporate Governance: Fostering Good Corporate Governance in the New Normal</strong>, December 6, 2022, Zoom Webinar</div>

                                    <div class="text-med " style="color:#003366;"><a href="https://www.megaworldcorp.com/investors/cg-seminar-certificate-attendance"><em><u><strong>View CG Seminar - Certificate of Attendance 2022 (PDF)</strong></u></em></a></div>
                                </div>
