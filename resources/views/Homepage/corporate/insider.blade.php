            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="1517" role="article" about="/investors/corporate-governance/insider-trading-policy" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="Insider Trading Policy" class="rdf-meta hidden"></span>
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="company-page page-policies">
                                        <h2 class="corporate-heading">Insider Trading Policy</h2>

                                        <p>Observe confidentiality</p>

                                        <p>A director should keep secure and confidential all non-public information he may acquire or learn by reason of his position as director. He should not reveal confidential information to unauthorized persons without the authority of the Board.</p>
                                    </div>
                                </div>
