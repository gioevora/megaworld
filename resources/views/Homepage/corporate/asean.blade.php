                        ...
                        <article data-history-node-id="1515" role="article" about="/corporate-governance/about" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">
                            ...
                            <div class="node__content">
                                ...
                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    ...
                                    <h2 class="corporate-heading">ASEAN CG Scorecard</h2>

                                    <div class="company-page page-risk-management" style="text-align:justify;">
                                        <p>The Institute of Corporate Directors (ICD) releases an annual survey based on an independently verified “scorecard” rating of corporate governance for publicly listed companies in the Philippines. ICD is a professional organization that is based in the Philippines and is accredited by the Securities and Exchange Commission (SEC) and the Philippine Stock Exchange (PSE). ICD works closely with the Organization for Economic Cooperation and Development (OECD), the Global Corporate Governance Forum, and the International Corporate Governance Network and is committed to promoting world-class corporate governance principles in the East Asia region.</p>
                                    </div>
                                </div>
