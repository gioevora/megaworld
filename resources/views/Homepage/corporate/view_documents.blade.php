                    ...
                    <div class="region region-two-col-main">
                        <article data-history-node-id="1439" role="article" about="/investors/corporate-governance/whistle-blowing-policy" class="node townships node--type-reports node--promoted node--view-mode-full">
                            ...
                            <div class="company-page">
                                <h2 class="corporate-heading">{{ $corpo->section }}</h2>

                                <div class="link-title-wrapper">
                                    <div class="title">
                                        <span class="fa fa-file-pdf">&nbsp;</span>
                                        <span class="field field--name-title field--type-string field--label-hidden">{{ $corpo->name }}</span>
                                    </div>
                                ...
                                <div class="pdf-wrapper">
                                    <iframe src="{{ asset('/storage/documents/' . $corpo->files_name) }}?embedded=true" style="width:700px; height:700px;" frameborder="0"></iframe>
                                </div>
                        ...
                        <nav role="navigation" aria-labelledby="block-corporategovernance-2-menu" id="block-corporategovernance-2" class="block block-menu navigation main-nav menu--corporate">
                            ...
                            <ul class="menu">
                                <li class="menu-item active">
                                    <a href="/corporate-governance/manual" data-drupal-link-system-path="node/585">Manual on Corporate Governance</a>
                                </li>
                                <li class="menu-item">
