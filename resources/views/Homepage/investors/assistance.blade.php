...
<body style="background-image: url('img/home-bg-pattern.png'); background-repeat:repeat; z-index: -2;">
    ...
    <div class="video-container">
        <img src="{{asset('img/IR-programs.jpg')}}" alt="Background Image" style="background-size: cover; width: 100%;">
        <div class="title-header">
            <p style="font-size: 50px; text-align:start; margin-top:5%;">INVESTOR RELATIONS</p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="region region-two-col-main">
                        ...
                        <article data-history-node-id="153" role="article" about="/investors/investor-relations/investors-assistance" typeof="schema:WebPage" class="node page node--type-page node--view-mode-full">


                            <span property="schema:name" content="Investors Assistance" class="rdf-meta hidden"></span>

                            <div class="node__content">

                                <div property="schema:text" class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="company-page contact-us investors-assistance">
                                        <h2 class="corporate-heading">Investors Assistance</h2>

                                        <div class="text-med" style="color:#003366;">Investor Relations Department</div>

                                        <div class="grid-item">
                                            <table class="contact-wrapper">
                                                <tbody>
                                                    <tr>
                                                        <td class="fa fa-phone">&nbsp;</td>
                                                        <td>(632) 8-894-6300 / 7-905-2800</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fa fa-envelope">&nbsp;</td>
                                                        <td><a href="mailto:investorrelations@megaworldcorp.com">investorrelations@megaworldcorp.com</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>

                                        <div class="text-med" style="color:#003366;">Stock Transfer Agent</div>

                                        <div class="grid-item">
                                            <table class="contact-wrapper">
                                                <tbody>
                                                    <tr>
                                                        <td class="fa fa-university">&nbsp;</td>
                                                        <td>BDO Unibank, Inc.<br>
                                                            Trust and Investments Group - Securities Services (Stock Transfer)</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fa fa-map-marker">&nbsp;</td>
                                                        <td>46th Floor BDO Corporate Center Ortigas, East Tower<br>
                                                            12 ADB Avenue, Mandaluyong City</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fa fa-phone">&nbsp;</td>
                                                        <td>8878-4961</td>
                ...
                <div class="col-md-4">
                    <div class="region region-two-col-right">
                        <nav role="navigation" aria-labelledby="block-investorrelations-menu" id="block-investorrelations" class="block block-menu navigation main-nav menu--investor-relations">

                            <h2 id="block-investorrelations-menu">Investor Relations</h2>



                            <ul class="menu">
                                <li class="menu-item menu-item--active-trail">
                                    <a href="/investor-relations-program" data-drupal-link-system-path="node/154" class="is-active">Investor Relations Program</a>
                                </li>
                                <li class="menu-item">
                                    <a href="/investors-assistance" data-drupal-link-system-path="node/153">Investors Assistance</a>
                                </li>
                                <li class="menu-item">
                                    <a href="/share-information" data-drupal-link-system-path="node/613">Share Information</a>
                                </li>
                                <li class="menu-item">
                                    <a href="/presentations-and-others" data-drupal-link-system-path="node/608">Presentations and Others</a>
                                </li>
                            </ul>
