...
<body style="background-image: url('img/home-bg-pattern.png'); background-repeat:repeat; z-index: -2;">
    ...
    <div class="site-navbar-wrap" style="background-color:rgba(22, 116, 193, 0.7);  ">
                        ...
                        <p>Location
                            <span>
                                <select name="location" id="locationFilter">
                                    <option value="Bacolod">All</option>
                        ...
                        <p>Type
                            <span>
                                <select name="type" id="typeFilter">
                                    ...
                                    <option value="LifestyleCommunity">Integrated Lifestyle Community</option>
                                    <option value="OtherProjects">Other Projects</option>
                                </select>
                            </span>
                        </p>
                    </div>
        ...
        <div class="view-content">
            ...
            <div>
                <ul id="townshipList" class="row">
                    ...
                    <li class="col-md-4" data-location="{{$town->location}}" data-type="{{$town->type}}">
