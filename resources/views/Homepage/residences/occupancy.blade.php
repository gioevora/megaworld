...
<body style="background-image: url('img/home-bg-pattern.png'); background-repeat:repeat;">

    <div class="site-navbar-wrap js-sticky-header"  style="background-color:#1674c1">
    ...
    <main>
        <div class="video-container">
            <img src="{{asset('img/banner2.png')}}" alt="Background Image" style="background-size: cover; max-width: 100%; margin-top: 15%;">
            <div class="residence">
                <div class="row">
                    <div class="col-md-7">

                        <p class="banner-header">We're ready when you are</p>
                        <p class="banner-text">We have designated specialized teams — the RFO Premier group (Makati, Fort Bonifacio, and Pasay City) and the Megaworld Regional RFO group (Quezon CIty, Cebu and Iloilo) — to cater to your needs based on your preferred locations.</p>
                        <img src="{{asset('img/MRFO.png')}}" alt=""> <img src="{{asset('img/MRFO.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="container pt-4">
            ...
            <div>
                <ul id="townshipList" class="row">
                    ...
                    <li class="col-md-4" data-location="{{$town->location}}" data-type="{{$town->status}}">
